...
version = {{ keyOrDefault (print (env "CONSUL_PATH") "/mempool.version") "\"v0\"" }}
...
ttl-num-blocks = {{ keyOrDefault (print (env "CONSUL_PATH") "/mempool.ttl-num-blocks") "0" }}
