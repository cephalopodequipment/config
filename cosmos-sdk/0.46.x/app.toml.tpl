...
enable-fee-suggestion = {{ keyOrDefault (print (env "CONSUL_PATH") "/base.enable-fee-suggestion") "\"false\"" }}

# GasToSuggest defines gas limit when calculating the fee
gas-to-suggest = {{ keyOrDefault (print (env "CONSUL_PATH") "/base.gas-to-suggest") "200000" }}

# DenomToSuggest defines the defult denom for fee suggestion.
# Price must be in minimum-gas-prices.
denom-to-suggest = {{ keyOrDefault (print (env "CONSUL_PATH") "/base.denom-to-suggest") "\"uatom\"" }}
...
max-gas-wanted-per-tx = {{ keyOrDefault (print (env "CONSUL_PATH") "/osmo.max-gas-wanted-per-tx") "\"25000000\"" }}
...
arbitrage-min-gas-fee = {{ keyOrDefault (print (env "CONSUL_PATH") "/osmo.arbitrage-min-gas-fee") "\".005\"" }}
