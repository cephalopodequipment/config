...
# Default:
# StartPollers=5
StartPollers={{ keyOrDefault (print (env "CONSUL_PATH") "/StartPollers") "5" }}
...
StartPreprocessors={{ keyOrDefault (print (env "CONSUL_PATH") "/StartPreprocessors") "3" }}
...
StartPollersUnreachable={{ keyOrDefault (print (env "CONSUL_PATH") "/StartPollersUnreachable") "1" }}
...
# Default:
# StartTrappers=5
StartTrappers={{ keyOrDefault (print (env "CONSUL_PATH") "/StartTrappers") "5" }}
...
# Default:
# StartPingers=1
StartPingers={{ keyOrDefault (print (env "CONSUL_PATH") "/StartPingers") "1" }}
...
# Default:
# StartHTTPPollers=1
StartHTTPPollers={{ keyOrDefault (print (env "CONSUL_PATH") "/StartHTTPPollers") "1" }}
