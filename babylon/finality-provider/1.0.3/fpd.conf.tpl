...
NumPubRand = {{ keyOrDefault (print (env "CONSUL_PATH") "/NumPubRand") "50000" }}

; The delay, measured in blocks, between a randomness commit submission and the randomness is BTC-timestamped
TimestampingDelayBlocks = {{ keyOrDefault (print (env "CONSUL_PATH") "/TimestampingDelayBlocks") "18000" }}
...
BatchSubmissionSize = {{ keyOrDefault (print (env "CONSUL_PATH") "/BatchSubmissionSize") "100" }}
