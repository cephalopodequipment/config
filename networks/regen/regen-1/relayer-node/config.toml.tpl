...
laddr = '{{ "tcp://0.0.0.0" }}:{{ env "NOMAD_PORT_rgn_rpc" }}'
...
laddr = '{{ "tcp://0.0.0.0" }}:{{ env "NOMAD_PORT_rgn_p2p" }}'
...
max_num_inbound_peers = {{ keyOrDefault "regen/relayer/p2p.max_num_inbound_peers" "20" }}

# Maximum number of outbound peers to connect to, excluding persistent peers
max_num_outbound_peers = {{ keyOrDefault "regen/relayer/p2p.max_num_outbound_peers" "50" }}
...
prometheus_listen_addr = '{{ "tcp://0.0.0.0" }}:{{ env "NOMAD_PORT_rgn_prom" }}'
