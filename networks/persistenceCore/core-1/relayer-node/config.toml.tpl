...
max_num_inbound_peers = {{ keyOrDefault "core/relayer/p2p.max_num_inbound_peers" "5" }}

# Maximum number of outbound peers to connect to, excluding persistent peers
max_num_outbound_peers = {{ keyOrDefault "core/relayer/p2p.max_num_outbound_peers" "50" }}
