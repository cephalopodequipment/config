...
minimum-gas-prices = "{{ keyOrDefault (print (env "CONSUL_PATH") "/base.minimum-gas-prices") "0.1" }}uosmo"
...
halt-height = {{ keyOrDefault (print (index (env "CONSUL_PATH" | split "/") 0) "/base.halt-height") "0" }}
