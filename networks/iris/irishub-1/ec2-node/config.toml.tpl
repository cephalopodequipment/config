...
rpc_servers = {{ keyOrDefault "iris/state-sync.rpc_servers" "\"\"" }}
trust_height = {{ keyOrDefault "iris/state-sync.trust_height" "0" }}
trust_hash = {{ keyOrDefault "iris/state-sync.trust_hash" "\"\"" }}
