...
[p2p]
  maxpeers = {{ keyOrDefault (print (env "BOR_CONSUL_PATH") "/bor.maxpeers") "2000" }}
  maxpendpeers = {{ keyOrDefault (print (env "BOR_CONSUL_PATH") "/bor.maxpendpeers") "500" }}
  bind = "0.0.0.0"
...
[heimdall]
  url = "{{ env "NOMAD_HOST_IP" }}{{ env "NOMAD_HOST_PORT" }}"
  "bor.without" = false
  # WebSocket address for Heimdall v2 communication (required for v2)
  ws-address = "{{ env "NOMAD_HOST_IP" }}:{{ env "NOMAD_HOST_PORT" }}"
