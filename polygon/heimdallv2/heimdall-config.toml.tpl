...
bor_rpc_url = "http://0.0.0.0:{BOR_RPC_PORT}"

# GRPC flag for bor chain
bor_grpc_flag = "false"

# GRPC endpoint for bor chain
bor_grpc_url = "0.0.0.0:{BOR_GRPC_PORT}"

# RPC endpoint for tendermint
tendermint_rpc_url = "http://0.0.0.0:{{ env "NOMAD_PORT_rpc" }}"
...
heimdall_rest_server = "http://0.0.0.0:{NOMAD_PORT_rest}"
