...
max_gas_price = {{or .max_gas_price 0.001 }} # this is the max gas price that will be used (this is the gas_price determined from EIP fee plus the gas_price_multiplier)
