...
gas_price_multiplier = {{or .gas_price_multiplier 1.1 }} # this value is added to the dynamic gas_price to ensure that the tx will be accepted
max_gas_price = {{or .max_gas_price 0.00001 }} # this is the max gas price that will be used (this is the gas_price determined from EIP fee plus the gas_price_multiplier)
